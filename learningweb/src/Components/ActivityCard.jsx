...
const ActivityCard = ({ day, activities }) => (
    <div className="bg-white pb-4 px-2 md:px-4 w-[280px] md:w-[220px] h-[300px] md:h-[350px] shadow-md rounded-md flex flex-col items-center">
...
const ActivityCards = ({ activities }) => {
    ...
    const nextCards = () => {
        setStartIndex((prevIndex) =>
            Math.min(prevIndex + 1, activities.length - cardsToShow)
        );
    };
